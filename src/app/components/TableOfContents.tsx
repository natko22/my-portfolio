            ...
            <div className="flex flex-col h-full">
              ...
              {!isMobile && (
                <div className="relative">
                  <div
                    onClick={onClose}
                    className="absolute -right-6 -top-[38rem] xxxs:-top-[38rem] xxs:-top-[40rem] sm:-top-[42rem] md:-top-[53rem] tablet:-top-[52rem] lg:-top-[44rem] xl:-top-[46rem] cursor-pointer transform hover:-translate-y-2 transition-transform duration-300 z-50"
                  >
                    <div className="relative">
